...
class BlogSpider(scrapy.Spider):
    ...
    def report(self, response):
        ...
        with open('jefferson.csv', 'a') as csvfile:
            headers = ['h_address','SWIS','owner_info', 'land_assessment', 'total_assessment', 'total_acerage', 'full_market_value', 'bathrooms', 'bedrooms','living area','SecondStoryArea','BuildingStyle','PorchType','PorchArea','OverallCondition','OverallGrade','SewerType','Utilities','WaterSupply']
        ...
        with open('jefferson.csv', 'a') as csvfile:
            ...
            filewriter.writerow([h_address,swis,owner_info, land_assessment, total_assessment, total_acreage, full_market_value, bedrooms,living_area,second_story_area,building_style,porch_type,porch_area,overall_condition,overall_grade,sewer_type, r_utilities, water_supply])
